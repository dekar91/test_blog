                ...
                <div class="row">
                    ...
                    <div class="post-annotation col-sm-12">{{ strip_tags(substr($post->content,0, 40)) }}</div>
                        <div class="post-buttons col-sm-12">
                            @if($post->canDelete())
                                <a href="{{ route('post-delete', ['slug' => $post->slug]) }}" class="post-delete" title="Remove post"><i class="fa fa-trash-o"></i></a>
                                <a href="{{ route('post-create', ['postId' => $post->id]) }}" class="post-delete" title="Edit post"><i class="fa fa-edit"></i></a>
                                @endif
                        </div>
                    </div>
                </div>
